  ...
  armRef
	...
	return (
		<div className={clsx(styles.FemaleAvatar, props.className)}>
			<img className={styles.teacher} src="/tlab-website/images/maestra.png" alt={props.alt} />
			<img ref={armRef} className={styles.arm} src="/tlab-website/images/maestra-braccio.png" alt={props.alt} />
		</div>
	);
}
